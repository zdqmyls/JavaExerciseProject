...
public class BarChartFrameController {
    ...
    public void initialize() {
        publicTools.public_addComboBoxItems(barChart_comboBox, new String[]{"今天", "昨天", "最近3天", "最近7天", "最近30天", "最近1年（12月）", "最近1年（4季度）"});
    }
    ...
    public void barChart_comboBoxEvent(ActionEvent event) {
        ...
        if (selectedCoboboxItem.equals("今天")) {
            String todayDate = dateTools.dateFormat(new Date(), "yyyy-MM-dd");
            ...
            String yesterdayDate = dateTools.dateFormat(dateTools.getYesterdayDate(), "yyyy-MM-dd");
            ...
            String seasonInputSql1 = "select SUM(rMoney) from tb_records where rType='收入' and rDate between '" + dateTools.dateFormat(date1[0], "yyyy-MM-dd") + "' and '" + dateTools.dateFormat(date1[1], "yyyy-MM-dd") + "'";
            String seasonOutputSql1 = "select SUM(rMoney) from tb_records where rType='支出' and rDate between '" + dateTools.dateFormat(date1[0], "yyyy-MM-dd") + "' and '" + dateTools.dateFormat(date1[1], "yyyy-MM-dd") + "'";
            ...
            String seasonInputSql2 = "select SUM(rMoney) from tb_records where rType='收入' and rDate between '" + dateTools.dateFormat(date2[0], "yyyy-MM-dd") + "' and '" + dateTools.dateFormat(date2[1], "yyyy-MM-dd") + "'";
            String seasonOutputSql2 = "select SUM(rMoney) from tb_records where rType='支出' and rDate between '" + dateTools.dateFormat(date2[0], "yyyy-MM-dd") + "' and '" + dateTools.dateFormat(date2[1], "yyyy-MM-dd") + "'";
            ...
            String seasonInputSql3 = "select SUM(rMoney) from tb_records where rType='收入' and rDate between '" + dateTools.dateFormat(date3[0], "yyyy-MM-dd") + "' and '" + dateTools.dateFormat(date3[1], "yyyy-MM-dd") + "'";
            String seasonOutputSql3 = "select SUM(rMoney) from tb_records where rType='支出' and rDate between '" + dateTools.dateFormat(date3[0], "yyyy-MM-dd") + "' and '" + dateTools.dateFormat(date3[1], "yyyy-MM-dd") + "'";
            ...
            String seasonInputSql4 = "select SUM(rMoney) from tb_records where rType='收入' and rDate between '" + dateTools.dateFormat(date4[0], "yyyy-MM-dd") + "' and '" + dateTools.dateFormat(date4[1], "yyyy-MM-dd") + "'";
            String seasonOutputSql4 = "select SUM(rMoney) from tb_records where rType='支出' and rDate between '" + dateTools.dateFormat(date4[0], "yyyy-MM-dd") + "' and '" + dateTools.dateFormat(date4[1], "yyyy-MM-dd") + "'";
